   ...
   while(1)
   {
    ...
    case '3':
         ...
         case '4':
        {
         ...
         case '5':
            {
                cout<<"For knowing about new schemes visit our website: http://www.govthealth.org"<<endl;
                break;
            }

    case '6':
        {
            cout<<"Admin details contact 8776456783 or mail at admin.user@govt.ac.in"<<endl;
            break;
        }
        case '7':
        {
